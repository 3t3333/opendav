    ...
    pub const fn for_mode(is_dark: bool) -> Self {
        if is_dark {
            Self {
                ...
                reference_primary: Color32::from_rgb(65, 233, 255),
                reference_primary_faint: Color32::from_rgba_premultiplied(65, 233, 255, 110),
                reference_secondary: Color32::from_rgb(245, 247, 250),
                reference_secondary_faint: Color32::from_rgba_premultiplied(245, 247, 250, 110),
            ...
            Self {
                ...
                reference_primary: Color32::from_rgb(0, 102, 119),
                reference_primary_faint: Color32::from_rgba_premultiplied(0, 102, 119, 105),
                reference_secondary: Color32::from_rgb(55, 65, 81),
                reference_secondary_faint: Color32::from_rgba_premultiplied(55, 65, 81, 105),
